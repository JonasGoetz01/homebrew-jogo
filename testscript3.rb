...
Please run `brew audit --new testscript3` before submitting, thanks.
Editing /opt/homebrew/Library/Taps/homebrew/homebrew-core/Formula/testscript3.rb
class Testscript3 < Formula
  desc ""
  homepage ""
